  ...
  return (
    <div className="px-6 py-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        <p className="text-base font-semibold leading-7 text-orange-600">Introducing</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our Privacy Policy</h1>
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <figure className="mt-10 border-l border-orange-600 pl-9">
